...
namespace Klyte.TouchThis
{
    ...
    public class TouchThisTool : TransportTool
    {
        ...
        // Token: 0x060000D4 RID: 212 RVA: 0x00009934 File Offset: 0x00007B34
        ...
        // Token: 0x060000E7 RID: 231 RVA: 0x0000A630 File Offset: 0x00008830
        ...
        private Vector3 GetControlPoint(ushort segment)
        {
            ...
            if (!NetSegment.IsStraight(position, startDirection, position2, endDirection, out float num))
            {
                ...
                TTTUtils.doErrorLog("Warning! Invalid segment directions!");
            }
